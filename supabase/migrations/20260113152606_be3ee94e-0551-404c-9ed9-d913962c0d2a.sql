-- Corriger la fonction find_similar_indicators (type real vs double precision)
DROP FUNCTION IF EXISTS public.find_similar_indicators(integer, double precision);
